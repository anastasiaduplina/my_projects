...
//            + DBStructure.EVENT + " TEXT, "+DBStructure.TIME+ " TEXT, "+DBStructure.DATE+ " TEXT, "+DBStructure.MONTH+ " TEXT, "+DBStructure.YEAR+ " TEXT)" ;
    private static final String CREATE_EVENT_TABLE= "CREATE TABLE IF NOT EXISTS " + DBStructure.EVENT_TABLE_NAME +" ("+ DBStructure.ID +" INTEGER PRIMARY KEY AUTOINCREMENT, "
